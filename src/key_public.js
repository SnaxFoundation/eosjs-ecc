...
/**
  ...
  @param {string} [pubkey_prefix = 'SNAX']
*/
function PublicKey(Q, pubkey_prefix = 'SNAX') {
    if(typeof Q === 'string') {
     ...
     * @arg {string} [pubkey_prefix = 'SNAX'] - public key prefix
    */
    function toString(pubkey_prefix = 'SNAX') {
...
/**
  ...
  @param {string} [pubkey_prefix = 'SNAX']
*/
PublicKey.isValid = function(pubkey, pubkey_prefix = 'SNAX') {
    try {
...
*/
PublicKey.fromString = function(public_key, pubkey_prefix = 'SNAX') {
    try {
...
/**
    ...
    @return PublicKey
*/
PublicKey.fromStringOrThrow = function(public_key, pubkey_prefix = 'SNAX') {
