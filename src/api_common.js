...
ecc.randomKey().then(privateKey => {
  ...
  console.log('Public Key:\t', ecc.privateToPublic(privateKey)) // SNAXkey...
    ...
    */
    privateToPublic: (wif, pubkey_prefix = 'SNAX') =>
      PrivateKey(wif).toPublic().toString(pubkey_prefix),

    /**
        @arg {pubkey} pubkey - like SNAXKey..
        @arg {string} [pubkey_prefix = 'SNAX']

        @return {boolean} valid

        @example ecc.isValidPublic(pubkey) === true
    */
    isValidPublic: (pubkey, pubkey_prefix = 'SNAX') =>
    ...
    */
    ...
    /**
        ...
        @arg {String|Buffer} signature (SNAXbase58sig.., Hex, Buffer)
